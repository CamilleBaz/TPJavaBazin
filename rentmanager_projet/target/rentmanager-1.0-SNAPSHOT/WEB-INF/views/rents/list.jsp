                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${reservations}" var="reservation">
                                	 ...
                                	 <!-- Popup Modal -->
										<div class="modal fade" id="supprModal${reservation.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										  <div class="modal-dialog" role="document">
										    <div class="modal-content">
										      ...
										      <div class="modal-body">
										        Etes-vous surs de vouloir supprimer la reservation n.${reservation.id}?
										      </div>
										      <div class="modal-footer">
										        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
										        <a class="btn btn-primary" href="${pageContext.request.contextPath}/rents/delete?id=${reservation.id}">Confirmer</a>
										      </div>
										    </div>
										  </div>
										</div>
	                                ...
	                                <tr>
	                                    ...
	                                    <td>
	                                        ...
	                                        <a class="btn btn-danger" data-toggle="modal" data-target="#supprModal${reservation.id}">
